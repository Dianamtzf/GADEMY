...
<section class="home-section">
    ...
    <h2 class="titulo" style="text-align: center; font-size: 40px; font-weight: 600; color: white; margin-top: 20px;">Teachers</h2>
                    ...
                    <div class="card" style="  box-shadow: 1px 0px 12px 4px rgba(0,0,0,0.49);
                        ...
                        <div style="flex: 2; margin-left: 20px;">
                            <div class="card-title">
                                <span style="font-size: 20px; font-weight: 700;"><?= $maestro['name']?></span>
                                <br>
                            </div>
                            <div class="card-body">
